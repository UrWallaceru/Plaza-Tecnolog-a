...
<body>
    <header>
        <div class="header_style">
            <div class="space_header"><img class="header_image_icon" src="images/logoColor2.png" alt=""></div>
            ...
            <div class="adjust_menu"><a href="{{ route('loginUser') }}"><i class="material-icons" style="font-size:36px">add_shopping_cart</i> carrito</a></div>
            <div class="adjust_menu"><a href="login.php"><i class="material-icons" style="font-size:36px">account_box</i> salir</a></div>
        </div>
