...
<body>
    <header>
        <div class="header_style">
            ...
            <div class="adjust_menu"><a href="{{ route('pedidosLocal',$id) }}"><i class="material-symbols-outlined" style="font-size:36px">file_open</i> pedidos</a></div>
            <div class="adjust_menu"><a href="{{ route('local',$id) }}"><i href="homepage.html" class="material-icons" style="font-size:36px">home</i> home</a></div>
