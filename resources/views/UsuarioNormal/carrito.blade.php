...
<body>
    ...
    <div class="tabla_productos">
        <div><h1>Productos de Carrito</h1></div>
        <table class="table">
            <thead>
              <tr>
        ...
        <h1>Total a pagar $<span class="badge badge-secondary">{{$total}}</span>
            <form action="{{  route('generarPedido',$id) }}" method ="POST">
                @foreach ($productos as $producto)
                    @csrf
                                <!--<td><input type="" name="id_producto[]" value="{{$producto->id}}" readonly></td>
                                <td><input class="" type="" value="{{$producto->nombre}}" name="nombre[]" readonly></td>
                                <td><input class="" type="" value="{{$producto->precio}}" name="total" readonly></td>
                                <td>-->
                @endforeach
                <!--<input type="" name="cantidad" value="{{$total}}" readonly>-->
